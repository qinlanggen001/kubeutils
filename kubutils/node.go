...
func (c *Node) GET(name string) (item interface{}, err error) {
...
func (c *Node) List(labelSelector, fieldSelector string) (item interface{}, err error) {
